...
export default {
    ...
    computed: {
        ...
        flagErrorDbBukken_MensekiFormat() {
            return !(this.regMenseki.test(this.buildingZhy.dbBukken_Menseki + ''));
        },
        ...
        computedSonotaNenHensai12No1(){
            if(this.buildingZhy.dbHensaiHouhou ==null || this.buildingZhy.dbHensaiHouhou == ""){
                return 0;
            }
