    ...
    <div>
        ...
        <div>
            ...
            <div>
                ...
                <div class="kiho">
                    <input type="checkbox" value="困難である" v-model="buildingZhy.dbHigaiJokyoDaikiboHankaiOrHankai" />困難である
                </div>
            </div>
 ...
 -->
        ...
        <div>
            ...
            <div>
                ...
                <div class="kiho">
                    <input type="number" v-model="buildingZhy.bKariireGakuNenHensai12No1"  />
                </div>
            </div>
            <div>
            ...
            <div>
                ...
                <div class="kiho">
                    <select v-model="buildingZhy.dbHisaiShinzokuDokyoAri">
                        <option value="">01有</option>
                        <option value="">02無</option>
                    </select>
                </div>
            </div>
            <div>
